...
<body>
    <section class="menu-header">
        ...
        <div class="menu">
            ...
            <div class="column">
                <a href="menu-noodles.php"><h3>เส้น</h3></a>
            </div>
        </div>
    </section>
    ...
    <section class="menuall" id="menuall">
            <ul class="accordion">
                <li>
                    ...
                    <div class="content">
                        <?php foreach ($menus_rice['pork'] as $item): ?>
                ...
                <li>
                    ...
                    <div class="content">
                        <?php foreach ($menus_rice['chicken'] as $item): ?>
                            <div class="item"><?= $item ?></div>
                        <?php endforeach; ?>
                    </div>
                </li>
                <li>
                    ...
                    <div class="content">
                        <?php foreach ($menus_rice['beef'] as $item): ?>
                            <div class="item"><?= $item ?></div>
                        <?php endforeach; ?>
                    </div>
                </li>
                <li>
                    ...
                    <div class="content">
                        <?php foreach ($menus_rice['fish'] as $item): ?>
                            <div class="item"><?= $item ?></div>
                        <?php endforeach; ?>
                    </div>
                </li>
                <li>
                    ...
                    <div class="content">
                        <?php foreach ($menus_rice['squid'] as $item): ?>
                            <div class="item"><?= $item ?></div>
                        <?php endforeach; ?>
                    </div>
                </li>
                <li>
                    ...
                    <div class="content">
                        <?php foreach ($menus_rice['shrimp'] as $item): ?>
                            <div class="item"><?= $item ?></div>
                        <?php endforeach; ?>
                    </div>
                </li>
